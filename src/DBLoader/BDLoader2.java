...
/*
	...
	public BDLoader2() {
	    ...
	    estacion = new Estacion("Estacion Plaza Italia", "-34.910623, -57.955327", 12, operativa, "1900");
	    estacionDao.altaEstacion(estacion);
	    estacion = estacionDao.buscarPorNombre("Estacion Plaza Italia");
	    
	    bicicleta = new Bicicleta(new Date(), estacion);
	    bicicletaDao.altaBicicleta(bicicleta);
	    bicicleta = bicicletaDao.buscar(1);
	    
	    persona = new Persona("123456", "Gimenez", "Pedro", "55 N° 69", new Date(), "Masculino", "xxx@gmail.com");
	    personaDao.altaPersona(persona);
	    persona = personaDao.buscarPorDni("123456");
	    ...
	    perfil2 = perfilDao.buscarPorUsername("user");	
	    ...
	    estacionDao.cambiarEstadoEstacion(estacion.getNombre(), cerrada);
	    
	    estadoBiciDao.borrarEstadoBici(estadoBiciDao.buscarPorDescripcion("En reparacion"));
